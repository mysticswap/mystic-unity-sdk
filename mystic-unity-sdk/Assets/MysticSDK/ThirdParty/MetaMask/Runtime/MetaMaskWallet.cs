...
namespace MetaMask
{
    ...
    public class MetaMaskWallet : IProvider, IEvents, IMetaMaskEventsHandler, IDisposable
    {
        ...
        {
            Debug.Log("MetaMask Wallet do: public Task<TR> Request<TR>(MetaMaskEthereumRequest request)");
        ...
        {
            Debug.Log("MetaMask Wallet do: public Task<object> Request(MetaMaskEthereumRequest request)");
            return this.Request<object>(request);
        }

        public object Request(string method, object[] parameters = null)
        {
            Debug.Log("MetaMask Wallet do: public object Request(string method, object[] parameters = null)");
        ...
        {
            Debug.Log("MetaMask Wallet do: public Task<TR> Request<TR>(string method, object[] parameters = null)");
